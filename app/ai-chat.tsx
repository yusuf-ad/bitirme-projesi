...
const QUICK_SUGGESTIONS = [
  ...
  },
  {
    ...
    text: "Suggest 3 low calorie recipes",
    color: "#4ECDC4",
  },
  { icon: "timer", text: "Quick 15-minute meals", color: "#FFE66D" },
  { icon: "eco", text: "Healthy snack ideas", color: "#95E1D3" },
];
      ...
      >
          ...
          style={[
            styles.recipeCardCompact,
            {
              backgroundColor: isDark
                ? ContentDarkColors.card.backgroundElevated
                : "#FFFFFF",
              borderColor: isDark
        ...
        >
          ...
          <View style={styles.recipeInfoCompact}>
            <Text style={styles.recipeTitleCompact} numberOfLines={2}>
              {recipe.title}
            </Text>
        ...
        <View style={styles.recipeInfo}>
          ...
          {recipe.readyInMinutes && (
            <View style={styles.recipeMetaRow}>
              ...
              />
              <Text
                style={[styles.recipeMeta, { color: colors.text.tertiary }]}
              >
                {recipe.readyInMinutes} min
              </Text>
            </View>
    ...
    try {
      ...
      const messagesWithRecipes = [...messages, newUserMessage].map((m) => {
        ...
        if (m.role === "assistant" && m.recipes && m.recipes.length > 0) {
          const recipeTags = m.recipes
            .map(
              (r) => `[[RECIPE:${r.title.toLowerCase().replace(/\s+/g, "_")}]]`
            )
            .join(" ");
    ...
    () => (
      <View style={styles.emptyContainer}>
        ...
        <View style={styles.emptyAvatarWrapper}>
          <View
            style={[styles.avatarGlow, { backgroundColor: colors.lilac[200] }]}
          />
          <LinearGradient
        ...
        <Text style={[styles.emptySubtitle, { color: colors.text.secondary }]}>
          I can help you with recipes, nutrition tips, and anything related to
          cooking.
        </Text>
        ...
        <View style={styles.suggestionsContainer}>
          <Text
            style={[styles.suggestionsTitle, { color: colors.text.tertiary }]}
          >
            Quick Suggestions
          </Text>
