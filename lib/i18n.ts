...
const en = {
  ...
  profile: {
    ...
    tastePreferencesDesc: "Meals, cuisines & dislikes",
    allergiesDietDesc: "Medical restrictions & macros",
    cookingSkillDesc: "Currently",
  ...
  integrations: {
    title: "Integrations",
    appleWatch: "Apple Watch",
    appleWatchDesc: "Sync rings, activity calories and mindfulness minutes.",
    lastSynced: "Last synced",
    justNow: "just now",
    partnerAccounts: "Partner accounts",
    strava: "Strava",
    stravaDesc: "Pull in workouts to adjust calorie targets.",
    fitbit: "Fitbit",
    fitbitDesc: "Sync steps, sleep and readiness scores.",
    appleHealth: "Apple Health",
    appleHealthDesc: "Mirror mindfulness minutes and water intake.",
  },
  // Cuisines
  cuisines: {
    italian: "Italian",
...
const tr = {
  ...
  profile: {
    ...
    tastePreferencesDesc: "Öğünler, mutfaklar & beğenmediklerin",
    allergiesDietDesc: "Tıbbi kısıtlamalar & makrolar",
    cookingSkillDesc: "Şu anda",
  ...
  integrations: {
    ...
    appleWatch: "Apple Watch",
    appleWatchDesc: "Halkaları, aktivite kalorilerini ve farkındalık dakikalarını senkronize edin.",
    lastSynced: "Son senkronizasyon",
    justNow: "az önce",
    partnerAccounts: "Partner hesapları",
    strava: "Strava",
    stravaDesc: "Kalori hedeflerini ayarlamak için antrenmanları çekin.",
    fitbit: "Fitbit",
    fitbitDesc: "Adımları, uyku ve hazırlık puanlarını senkronize edin.",
    appleHealth: "Apple Health",
    appleHealthDesc: "Farkındalık dakikalarını ve su alımını yansıtın.",
  },
  // Cuisines
  cuisines: {
    italian: "İtalyan",
